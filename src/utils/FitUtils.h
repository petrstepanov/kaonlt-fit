...
public:
	...
	static void doFit(TH1* hist, FitParameters* pars, AbsComponentFunc* funcObject, TVirtualPad* pad = 0, Bool_t noTerm0 = kFALSE);
	static void doFitTest(TH1* hist, FitParameters* pars);
	static void doRooFit(TH1* hist, FitParameters* pars, Bool_t useTerm0 = kTRUE, TVirtualPad* pad = 0);
	...
	static void fitHistogramOnPad(TH1* hist, TVirtualPad* pad, FitParameters* params, FitType fitType);

...
SIdealNPdf::SIdealNPdf(const char *name, const char *title, RooAbsReal& _x, RooAbsReal& _Q1, RooAbsReal& _s1, RooAbsReal& _mu, RooAbsReal& _n) :
		RooAbsPdf(name, title), x("x", "x", this, _x), Q1("Q1", "Q1", this, _Q1), s1("s1", "s1", this, _s1), mu("mu", "mu", this, _mu), n("n", "n", this, _n) {
}

SIdealNPdf::SIdealNPdf(const SIdealNPdf& other, const char* name) :
		RooAbsPdf(other, name), x("x", this, other.x), Q1("Q1", this, other.Q1), s1("s1", this, other.s1), mu("mu", this, other.mu), n("n", this, other.n) {
}
